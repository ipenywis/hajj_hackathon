...
Object.defineProperty(exports, "__esModule", { value: true });
//Style
__webpack_require__(/*! ./src/sass/mainSty.scss */ "./src/sass/mainSty.scss");
//Main Renderer
__webpack_require__(/*! ./src/ts/renderer */ "./src/ts/renderer.tsx");
...
/***/ "./src/ts/components/dashboard/index.tsx":
/*!***********************************************!*\
  !*** ./src/ts/components/dashboard/index.tsx ***!
  \***********************************************/
/*! no static exports found */
...
class Dashboard extends React.Component {
    ...
    render() {
        return (React.createElement("div", { className: "dashboard-container" },
            React.createElement(SelectLanguage, { languages: this.props.appState.languages })));
    }
}
...
const SelectLanguage = (props) => {
    ...
    const onChooseLanguage = (e, langCode) => {
        console.log("You Have Chosen: ", langCode);
    };
    return (React.createElement("div", { className: "dh-languages-container" }, languages.map((language, idx) => {
        return React.createElement("div", { className: "dh-language", key: idx, onClick: (e) => onChooseLanguage(e, language.code) }, language.name);
    })));
};
...
const store_1 = __webpack_require__(/*! ./store */ "./src/ts/store.tsx");
//Components
const dashboard_1 = __webpack_require__(/*! ./components/dashboard/ */ "./src/ts/components/dashboard/index.tsx");
//Render
ReactDOM.render(React.createElement(store_1.default, null,
    React.createElement(dashboard_1.default, null)), document.getElementById("root"));
...
class Store extends React.Component {
    ...
    render() {
        return (React.createElement("div", { className: "main-container" },
            ...
            !this.props.children && React.createElement("div", { style: {
                    textAlign: "center"
                } }, "No Childs To Render")));
    }
}
